...
public class ShowWin extends AnglePhysicsEngine{
	...
	public ShowWin(AngleSpriteLayout _bg,AngleSpriteLayout _btns,AngleVector WH,AngleFont font) {
		...
		Okbtn = new BtnSprite(_btns, new AngleVector((int)(WH.mX/2)+_btns.roWidth*2/3,(int)(WH.mY/2)+_bg.roHeight/2-_btns.roHeight/2), 0);
		Exitbtn = new BtnSprite(_btns, new AngleVector((int)(WH.mX/2)-_btns.roWidth*2/3,(int)(WH.mY/2)+_bg.roHeight/2-_btns.roHeight/2), 1);
		score_1 = new AngleString(font, "0", (int)((WH.mX/2)),(int)(WH.mY/2),AngleString.aCenter);
