...
public class AngleFont
{
	...
	public AngleFont(AngleSurfaceView view, float fontSize, Typeface typeface, int red, int green, int blue)
	{
		mTextureEngine=view.getTextureEngine();
		doInit(fontSize, typeface, (short) 100, (short) 0, red, green, blue, 255);
		mTexture=mTextureEngine.createTextureFromFont(this);
		sWidth = view.roWidth;
		sHeight = view.roHeight;
		isChinese = true;
	}
