...
public class AngleSurfaceView extends SurfaceView implements SurfaceHolder.Callback
{
	...
	public boolean getThreadStatic(){
	...
	{
		roWidth  = ((Activity) context).getWindowManager().getDefaultDisplay().getWidth();       // 屏幕宽（像素，如：480px）  
		roHeight = ((Activity) context).getWindowManager().getDefaultDisplay().getHeight();
	...
	{
		Log.d("log","surfaceCreated HOLDER");
	...
	public void onWindowFocusChanged(boolean hasFocus)
	{
	   ...
	   Log.d("log","onWindowFocusChanged="+hasFocus);
	}
