...
public class AngleActivity extends Activity
{
	...
	{
		super.onPause();
		Log.v("log","activity onpause");
		mGLSurfaceView.onPause();
		if (mCurrentUI != null)	mCurrentUI.onPause();
	}
