...
public class Game extends AngleActivity
{
	...
	public class MyDemo extends AngleUI
	{
		...
		public MyDemo(AngleActivity activity)
		{
			...
			tmGround = new AngleTileMap(tbGround, 320, 480, 15, 1000, false,false);
			...
			//>Ponemos la c�mara en la parte m�s baja del mapa
		...
		public boolean onTouchEvent(MotionEvent event)
		{
			...
			//>33 eventos por segundo como m�ximo
			try
			{
				Thread.sleep(30);
		...
		public void step(float secondsElapsed)
		{
			if(tmGround.mTop>tmGround.mHeight)
