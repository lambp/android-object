...
public class AngleTutorials extends Activity implements OnClickListener
{
	public void onCreate(Bundle b)
	{
		...
		Intent intent = new Intent(this, Tutorial02.class);
		startActivity(intent);
		//Client client = new Client("192.168.0.236");
	...
	private void createpng(){
		  Bitmap bitmap = Bitmap.createBitmap(100, 50, Config.ARGB_8888);  
          Canvas canvas = new Canvas(bitmap);  
          Paint paint = new Paint();  
          String ss = "测试中文";  
          canvas.drawText(ss, 0, 10, paint);  
